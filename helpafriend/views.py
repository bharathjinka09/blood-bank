...
def Submit(request):
    if request.method == 'POST':
        if request.POST.get('fname') and request.POST.get('blood') and request.POST.get('dob') and request.POST.get(
                'mobileno') and request.POST.get('country') and request.POST.get('state') and request.POST.get(
                'city') and request.POST.get('pincode') and request.POST.get('email') and request.POST.get(
                'password') and request.POST.get('rpassword') and request.POST.get('availability'):
            c = {}
...
def Submit_BloodBank(request):
    if request.method == 'POST':
        if request.POST.get('bank_name') and request.POST.get('country') and request.POST.get(
                'state') and request.POST.get('city') and request.POST.get('pincode') and request.POST.get(
                'contact_no') and request.POST.get('email') and request.POST.get('password') and request.POST.get(
                'rpassword') and request.POST.get('iso'):
            c = {}
            c.update(csrf(request))
            bd = BloodBankDetails()
...
def Search_Donor(request):
    if request.method == 'POST':
        if request.POST.get('search_by') and request.POST.get('blood') and request.POST.get(
                'country') and request.POST.get('state') and request.POST.get('city'):
            c = {}
            c.update(csrf(request))
            ...
            if search_by == 'donor':
                ...
                return render_to_response('bank_list.html', {'output_bank_list': output_bank_list,
                                                             'output_blood_list': output_blood_list})
...
def Post_Req(request):
    if request.session.has_key('user_id'):
        ...
        if request.method == 'POST':
            if request.POST.get('pname') and request.POST.get('blood') and request.POST.get('age') and request.POST.get(
                    'bdate') and request.POST.get('unit') and request.POST.get('mobileno') and request.POST.get(
                    'hospital') and request.POST.get('location') and request.POST.get('paddress') and request.POST.get(
                    'purpose'):
                c = {}
                c.update(csrf(request))
                rd = RequestDetails()
                ...
                print(mail_list)
                content = "Blood Request sent by " + request.POST.get('pname') + " Blood Group: " + request.POST.get(
                    'blood') + " Hospital: " + request.POST.get('hospital') + " Address: " + request.POST.get(
                    'location')
                print(content)
                recipient_list = []
